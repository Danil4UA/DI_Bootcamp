...
//   Create a function getCarHonda(carInventory) that takes a single parameter. carInventory‘s value is an array which is an 
//   inventory of cars (see the array of objects below)
...
function getCarHonda (carInventory) {
    let findHondaElement = carInventory.find(item=>item.car_make === "Honda")
    return `This is a ${findHondaElement.car_make} ${findHondaElement.car_model} from ${findHondaElement.car_year}.`
}
